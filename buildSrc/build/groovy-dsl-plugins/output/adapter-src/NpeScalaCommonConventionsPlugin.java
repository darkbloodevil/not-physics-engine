...
/**
 * Precompiled npe.scala-common-conventions script plugin.
 **/
public class NpeScalaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_NpeScalaCommonConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("scala");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_NpeScalaCommonConventions").asSubclass(BasicScript.class);
