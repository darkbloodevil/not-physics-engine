...
import npe.exceptions.ExcelFormatException;
...
public class ExcelReader {
     ...
     * tokens in result
     */
    public static String GAME_MAP = "game_map", HEADER = "[HEADER]", REPRESENT = "[REPRESENT]", ALTER = "[ALTER]", LIST = "[LIST]", NONE = "[NONE]", EMPTY_TOKEN = "[EMPTY]";
